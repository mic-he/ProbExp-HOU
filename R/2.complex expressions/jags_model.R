...
var likely[11], possible[11], unlikely[11], TMPmatrix[11,3],state.semantics[3,11], value.semantics[9,65], literal.state.bel[11,3], hypergeometric[65,11], TMPrational.bel[65,11], rational.bel[65,11],TMParray[3,65,11], EU.simple[3,65], TMPmatrix2[65,9], literal.value.bel[65,9], TMParray1[65,65,11], distances[65,65],avg.distance1[9,65], TMParray3[9,65,65],EU.complex1[9,65],TMPmatrix1[65,12], speaker.prob[65,12], TMParray2[12,65,11], listener.prob[12,65,11], TMPmatrix4[12,65], listener.prob.value[12,65], TMPmatrix5[12,11],listener.prob.state[12,11], countdata.value[12,65], countdata.state[12,11], fakedata.state[12,11]; 
...
model{  
  ...
  theta.possible=theta.might
  theta.likely=theta.probably
  ...
  for (m in 1:length(complex)){
    for (v in 1:length(values)){
      for (u in 1:length(values)){
        TMParray3[m,v,u]=distances[v,u]*value.semantics[m,u]
      }
      avg.distance1[m,v]=sum(TMParray3[m,v,])/sum(value.semantics[m,])
